...
class TripletSampler(tordata.sampler.Sampler):
    def __init__(self, dataset, batch_size, batch_shuffle=False):
        ...
        # Handle single-GPU or CPU scenario
...
def sync_random_sample_list(obj_list, k, common_choice=False):
    ...
    # Only perform distributed broadcasting if dist is initialized
...
class InferenceSampler(tordata.sampler.Sampler):
    def __init__(self, dataset, batch_size):
        ...
        batch_size_per_rank = int(self.batch_size / self.world_size)
        indx_batch_per_rank = []
        ...
        self.idx_batch_this_rank = indx_batch_per_rank[self.rank::self.world_size]
